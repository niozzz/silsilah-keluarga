...
$keluarga = query("SELECT * FROM keluarga JOIN hubungan ON keluarga.id=hubungan.id_keluarga1 WHERE id_keluarga1 = 3 AND nama_hubungan = 'orang tua'");

// var_dump($keluarga); die;
...
<body>
  ...
  <main class="main" id="top">
      ...
      <div class="container"><a class="navbar-brand" href="../#"><img src="../assets/img/gallery/logo.png" width="118"
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
            ...
            <li class="nav-item px-2"><a class="nav-link" href="../#findUs">Home</a></li>
      ...
      <div class="container">
        ...
        <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"></div>
          <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
            <h1 class="fw-light font-base fs-6 fs-xxl-7">Keluarga <strong>Mbah Yutir </strong></h1>
            <div class="list-group">
              <!-- <a href="../#" class="list-group-item list-group-item-action">
                The current link item
              </a> -->
              <?php foreach($keluarga as $d) : ?>
              <a href="../#" class="list-group-item list-group-item-action">Hj. Sumarni</a>
              <?php endforeach; ?>
              
              <!-- <a href="../#" class="list-group-item list-group-item-action">Hj. Sumarni</a>
              <a href="../#" class="list-group-item list-group-item-action">Juariyah</a>
              <a href="../#" class="list-group-item list-group-item-action">Suyadi</a>
              <a href="../#" class="list-group-item list-group-item-action">Dwi Yatmi</a>
              <a href="../#" class="list-group-item list-group-item-action">Suyatno</a>
              <a href="../#" class="list-group-item list-group-item-action">Suyatni</a>
              <a href="../#" class="list-group-item list-group-item-action">Hj. Suyanti</a> -->
            </div>
    ...
    <section class="py-0 bg-secondary fixed-bottom">
